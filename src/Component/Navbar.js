...
const Navbar = () => {
  ...
  return (
    <>
      {/* Top Contact Bar with Admin Login */}
      {(!isMobile || !isSticky) && (
        <div 
        ...
        >
          ...
          <div className="flex items-center gap-4 mt-2 md:mt-0">
            ...
            <Link 
              to="/adminToLogin" 
              className="ml-4 flex items-center gap-2 text-xs sm:text-sm bg-blue-800 hover:bg-blue-900 px-3 py-1.5 rounded-md transition-all duration-300 transform hover:scale-105"
              title="Admin Login"
            >
        ...
        {isOpen && (
          <div className="fixed inset-0 bg-gray-900 bg-opacity-95 z-10 flex flex-col items-center justify-center md:hidden pt-20">
            ...
            <button
              ...
              className="bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 px-6 py-2 rounded-lg font-semibold shadow-md hover:shadow-lg transition-all duration-300 transform hover:scale-105 mt-6"
            >
              Enroll Now
            </button>
            ...
            <Link 
              to="/adminToLogin" 
              onClick={() => setIsOpen(false)}
              className="flex items-center gap-2 text-sm bg-blue-800 hover:bg-blue-900 px-4 py-2 rounded-md transition-all duration-300 mt-4"
            >
              <FaUserShield className="text-blue-300" />
