    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-10 items-start text-center md:text-left">
      ...
      <div>
        ...
        <ul className="space-y-2 text-sm">
          ...
          <li><Link to="/course" className="hover:text-[#016fbe] transition">Courses</Link></li>
      ...
      <div className="flex flex-col sm-items-center  text-left md:items-start">
        ...
        <ul className="space-y-3 text-sm">
          ...
          <li className="flex items-center justify-center md:justify-start gap-2">
            ...
            <span>+92 3077875533</span>
          </li>
          <li className="flex items-center justify-center md:justify-start gap-2">
            <FaMapMarkerAlt className="text-[#016fbe]" size={30} />
            <a href='https://maps.app.goo.gl/LemGhwzbX6rXwdYDA'>DD 6 Commercial Formanites Housing Scheme, opposite DHA Phase 5, M Extension Lahore</a>
          </li>
        </ul>

        {/* Social Icons */}
        <div className="flex gap-4 mt-4 justify-center md:justify-start text-white">
          <a href="https://www.facebook.com/share/1FAhXjvyNG/" className="hover:text-[#016fbe]"><FaFacebookF /></a>
          <a href="https://www.linkedin.com/in/muhammad-bilal-7bb1b3278?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" className="hover:text-[#016fbe]"><FaLinkedinIn /></a>
          {<a href="https://web.whatsapp.com/" className="hover:text-[#016fbe]"><FaInstagram /></a>}
          <a href="https://web.whatsapp.com/" className="hover:text-[#016fbe]"><FaWhatsapp /></a>
        </div>
      </div>
    </div>
