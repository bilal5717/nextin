...
import ConsultationModal from '../Component/models/ConsultationModal';
...
const Services = () => {
  ...
  const openModalWithService = (serviceKey) => {
    setModalState({
      isOpen: true,
          ...
          {services.map(({ key, title, detailedDesc, image }, index) => (
            ...
            >
              ...
              <div className="md:w-1/2 w-full">
                ...
                <button 
                  onClick={() => openModalWithService(key)}
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <button 
              ...
              className="px-8 py-3 bg-white text-blue-600 font-bold rounded-lg hover:bg-gray-100 transition-colors duration-300 shadow-lg"
            >
